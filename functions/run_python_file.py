    ...
    parameters=types.Schema(
        ...
        properties={
            ...
            "args": types.Schema(
                ...
                description="Optional arguments to be passed to the python file when executed.",
                items=types.Schema(
                    type=types.Type.STRING,
                    description="Optional argument to be passed to the python file when executed."
                )
            ),
        },
    ),
